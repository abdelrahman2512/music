...
ob_start();
$API_KEY = '5325362670:AAEJy_EV91K_hXG15pxQxW06t1RnS5RIY40'; //add your bot token
$sudo = 1891486387; // add your id
$bot_id = 5325362670; 
$e = "@tes1t_5bot";
...
bot('sendMessage',[
    'chat_id'=>$chat_id,
    'text'=>"💯¦ مـرحبآ آنآ بوت آسـمـي التمساح 🎖
💰¦ آختصـآصـي حمـآيهہ‏‏ آلمـجمـوعآت
📛¦ مـن آلسـبآم وآلتوجيهہ‏‏ وآلتگرآر وآلخ...
👨🏽‍🔧",
    'reply_markup'=>json_encode([
      'inline_keyboard'=>[
        [['text'=>"آلمـطـور 🌿",'url'=>"https://t.me/UG_U6"]]
    ]
...
'first_name'=>"عبد الرحمن عبد الجليل",
...
bot('sendMessage',[
'chat_id'=>$chat_id, 
'text'=>"🛠¦   قناة مـطـور الملف : @php_eltamsah ☑️ ",
'reply_to_message_id'=>$message->message_id, 
]);
}
if($text == "🛠¦ المساعدة •"){
bot('sendMessage',[
'chat_id'=>$chat_id, 
'text'=>"💯¦ للمساعدة او اي أراء او افكار تواصل مع مطور الملف @UG_U6 √",
'reply_to_message_id'=>$message->message_id, 
]);
}
...
bot('sendMessage',[
'chat_id'=>$chat_id, 
'text'=>"لا تبكي حياتي لقد ابكيتني😂 😭😭",
'reply_to_message_id'=>$message->message_id, 
]);
}
if($text == "😡"){
...
bot('sendMessage',[
'chat_id'=>$chat_id, 
'text'=>"المطور عبد الرحمن يا عسل 🤍@UG_U6",
'reply_to_message_id'=>$message->message_id, 
]);
}
if($text == "اعزف"){
...
bot('sendMessage',[
'chat_id'=>$chat_id, 
'text'=>"مطورى م هنا دلوقت روح شوفو هنا @UG_U6او هنا f1ae00",
'reply_to_message_id'=>$message->message_id, 
]);
}
$message_id = $update->message->message_id;
